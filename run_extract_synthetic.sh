...
#SBATCH --mem=4G
#SBATCH --time=2:00:00
#SBATCH --output=logs/extract_synthetic_%a_%j.out
#SBATCH --error=logs/extract_synthetic_%a_%j.err
#SBATCH --job-name=ext_synth
#SBATCH --array=1-166
...
date
echo "Task ${SLURM_ARRAY_TASK_ID}: Synthetic DNMs for ${REGION}"
